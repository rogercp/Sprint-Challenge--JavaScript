...
*/
const animalNames = [];
const sName=zooAnimals.forEach(element => {
...
*/
const lowerCase = [];
const justNames=zooAnimals.map(element=>{
...
const lessThanFive=zooAnimals.filter(element=>{
  largerPopulation.push(element.population<5);
})
...
*/
const populationTotal = zooAnimals.reduce((total,amount)=>{
